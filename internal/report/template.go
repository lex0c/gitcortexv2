...
<h2>Concentration</h2>
<p class="hint">Pareto distribution across files, developers, and directories. Few items carrying 80% of activity = concentration hot-spot. Prioritize red and yellow markers — they flag single points of failure.</p>
