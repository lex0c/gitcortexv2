...
<div style="margin-bottom:16px;">
  ...
  <div style="font-size:11px; color:#656d76; font-style:italic; margin-bottom:6px;">Where this developer works. Percentage of unique files touched per directory.</div>
...
<div style="margin-bottom:16px;">
  ...
  <div style="font-size:11px; color:#656d76; font-style:italic; margin-bottom:6px;">Developers who modify the same files. Number = shared files.</div>
...
{{if .Profile.TopFiles}}
<h2>Top Files</h2>
<p style="font-size:11px; color:#656d76; font-style:italic; margin-bottom:8px;">Most impacted files by this developer. Churn = additions + deletions.</p>
<table>
...
{{if .ActivityYears}}
<h2>Activity</h2>
<p style="font-size:11px; color:#656d76; font-style:italic; margin-bottom:8px;">Monthly commit heatmap. Darker = more active. Gaps = inactive periods.</p>
...
{{if gt .MaxPattern 0}}
<h2>Working Hours</h2>
<p style="font-size:11px; color:#656d76; font-style:italic; margin-bottom:8px;">Commit distribution by day and hour. Reveals timezone and work-life patterns.</p>
